...
\begin{frame}{Valeur métier — À quoi sert G4 ?}
  ...
  \begin{columns}
    ...
    \textbf{Gestionnaire réseau (OPERATOR)}
    \begin{itemize}
...
\begin{frame}{Sécurité JWT}
  \begin{itemize}
    ...
    \item Rôles G3 : \texttt{ROLE\_OPERATOR}, \texttt{ROLE\_DISPATCHER}, \texttt{ROLE\_ADMIN\_G4}
...
\begin{frame}{Plan de démonstration (soutenance)}
  ...
  \begin{enumerate}
    \item \texttt{docker compose -f docker-compose.full-stack.yml ps}
...
\begin{frame}{DevOps — Démarrage}
  \footnotesize
  \texttt{docker compose -f docker-compose.full-stack.yml up -d --build}
  \vspace{0.3cm}
  \begin{itemize}
